from src.utils.Comtrade import *
import os
...
if __name__=='__main__':
    orig_file = 'data/PSCAD'
    fault_time_seconds = 0.3
    modify_comtrade_trigger_time(base_filepath=orig_file, fault_time_seconds=fault_time_seconds, backup=False)
